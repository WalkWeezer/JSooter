...
var map = [
		   [0,0,1000,0,180,0,2000,200,"#0C0F0A"],
		   [0,0,-1000,0,0,0,2000,200,"#0C0F0A"],
		   [1000,0,0,0,-90,0,2000,200,"#0C0F0A"],
		   [-1000,0,0,0,90,0,2000,200,"#0C0F0A"],
		   [0,100,0,90,0,0,2000,2000,"#0C0F0A"]
];
...
var pawn = new player(-800,-500,0,0,0);
...
function CreateNewWorld(){
    for (let i = 0; i < 20; i++) {
        for (let j = 0; j < 20; j++) {
		    let w = 100-borderWidth*2;
            let h = 100-borderWidth*2;
		    let newElement = document.createElement("div");
		    newElement.className = "floor";
		    newElement.id = "floor" + i;
		    newElement.style.width = w + "px";
		    newElement.style.height = h + "px";
		    newElement.style.background = "#0C0F0A";
	...
	for (let i = 0; i < map.length; i++){
		...
		let w = map[i][6]-borderWidth*2;
        let h = map[i][7]-borderWidth*2;
		let newElement = document.createElement("div");
		newElement.className = "wall";
		newElement.id = "wall" + i;
		newElement.style.width = w + "px";
		newElement.style.height = h + "px";
