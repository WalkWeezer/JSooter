...
**Exit criteria:**
- [x] Личина выбирается до миссии и влияет слабо, но заметно
- [x] Валюта сохраняется
- [x] Сюжетные миссии **не** гейтятся донатом/RV

**Статус Phase 5:** DONE (2026-07-16)
...
**Exit criteria:**
- [x] RV нигде не блокирует сюжет
- [x] Interstitial только в логической паузе
- [x] Consume вызывается
- [x] Mock mode покрывает ads/iap локально

**Статус Phase 6:** DONE (2026-07-16)
