...
**Exit criteria:**
- [ ] Новый игрок проходит tut → mission 3 без тупика
- [ ] Суммарный контент > 10 минут (треб. 2.9)
- [ ] Нарастающая сложность: враги 1→4 архетипов
- [ ] Все briefing/results строки в i18n
